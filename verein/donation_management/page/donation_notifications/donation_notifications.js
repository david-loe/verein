...
(() => {
	...
	const refresh = (wrapper) => {
		...
		return module.assetsReady.then(
			(ready) => ready && module.refresh_page("donation-notifications", wrapper)
		);
	};
	frappe.pages["donation-notifications"].on_page_load = refresh;
	frappe.pages["donation-notifications"].refresh = refresh;
})();
