...
(() => {
	...
	const refresh = (wrapper) => {
		...
		return module.assetsReady.then(
			(ready) => ready && module.refresh_page("cost-center-overview", wrapper)
		);
	};
	frappe.pages["cost-center-overview"].on_page_load = refresh;
	frappe.pages["cost-center-overview"].refresh = refresh;
})();
